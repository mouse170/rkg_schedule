...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: '樂天女孩 Rakuten Girls 即時看台班表',
        short_name: 'RKG 班表',
        description: '全猿主場應援席位查詢 • 當日出勤成員 • 站位資訊及女孩 IG 目錄',
        theme_color: '#140104',
        background_color: '#140104',
        display: 'standalone',
  ...
  base: './', // Using relative base for flawless GitHub Pages resolution
});
